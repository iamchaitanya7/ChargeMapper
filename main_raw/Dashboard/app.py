...
with col2: 
    with st.container():
        ...
        st.subheader("Legend")
        image = Image.open('C:/Users/ASUS/OneDrive/DataScience/FINAL-PROJECT/data-science-Optimal-EV-station-placement-main/main_raw/Dashboard/Data/Icon list.png')
...
with col1:
    ...
    df_ev_data = pd.read_csv('C:/Users/ASUS/OneDrive/DataScience/FINAL-PROJECT/data-science-Optimal-EV-station-placement-main/main_raw/Dashboard/Data/cleaned_ev_data_germany.csv')
    ...
    folium.TileLayer().add_to(saarbrucken_map_markers)
    folium.TileLayer().add_to(saarbrucken_map_markers)
    ...
    # Now for POIs
    # Get Curated data
    df_poi_data= load_poi_data('C:/Users/ASUS/OneDrive/DataScience/FINAL-PROJECT/data-science-Optimal-EV-station-placement-main/main_raw/Dashboard/Data/all_city_data_with_pop.csv')
    ...
    df_predicted = load_poi_data('C:/Users/ASUS/OneDrive/DataScience/FINAL-PROJECT/data-science-Optimal-EV-station-placement-main/main_raw/Dashboard/Data/saarbrucken_predicted_EV_stations.csv')
...
# width=1250, height=500
    ...
    saarbrucken_map_markers.save("C:/Users/ASUS/OneDrive/DataScience/FINAL-PROJECT/data-science-Optimal-EV-station-placement-main/main_raw/Dashboard/MymapNew.html")
...
# EDA / Results 
st.subheader("EDA")
image = Image.open('C:/Users/ASUS/OneDrive/DataScience/FINAL-PROJECT/data-science-Optimal-EV-station-placement-main/main_raw/Dashboard/Data/Number of different types of infrastructure in Saarbrucken.png')
